direccionesModulo = (function () {
  ...
  function calcularYMostrarRutas () {
    let origen = document.getElementById('desde').value;
    let destino = document.getElementById("hasta").value;
    let medio="";
    ...
    if( document.getElementById("comoIr").value == "Bus/Subterraneo/Tren"){
   ...
   /* Elimina borra la ruta del mapa y elimina la secuencia de pasos del panel */
  $(document).on("click","#borraRuta",function(){
